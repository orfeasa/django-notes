# Django Tutorial
<!-- Throughout the whole tutorial, I will be using `<name>` to indicate a name that can be changed. Brackets are obviously to be ommitted (change `<name>` to `my_var_name`, *not* `<my_var_name>`) -->
